			...
			(config: AxiosRequestConfig = {}) => {
				...
				if (config.headers) {
					...
					config.headers.token =
						'eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIxMjM3MDMwIiwidGVuYW50SWQiOiIxMjM3MDI3IiwiaWF0IjoxNjU5OTM3NTUzLCJleHAiOjE2NjAwMjM5NTN9.ruYBVlDabATDICx82V3ZInJoym0snaY-77nMNIs5NWo'
				}
